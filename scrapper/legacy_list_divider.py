...
with open("../data/no_pdf_list.txt", "r") as file:
...
with open("../data/no_pdf_list_div1.txt", "w") as file:
...
with open("../data/no_pdf_list_div2.txt", "w") as file:
...
with open("../data/no_pdf_list_div3.txt", "w") as file:
